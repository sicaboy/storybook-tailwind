  ...
  <div class="min-h-screen bg-white">
    <header class="relative pb-36 bg-blue-gray-800">
      <div class="absolute inset-0">
        ...
        />
        <div
          class="absolute inset-0 bg-blue-gray-800 mix-blend-multiply"
          aria-hidden="true"
        />
      </div>
      <Popover as="div" class="relative z-10">
        ...
        >
          <div class="flex items-center flex-1">
            <div class="flex items-center justify-between w-full lg:w-auto">
              ...
              <div class="-mr-2 flex items-center lg:hidden">
                <PopoverButton
                  class="bg-blue-gray-900 bg-opacity-0 rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-opacity-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white"
                >
          ...
          <div class="hidden lg:flex lg:items-center lg:space-x-6">
            <a
              href="#"
              class="py-2 px-6 bg-blue-500 border border-transparent rounded-md shadow-md text-base font-medium text-white hover:bg-blue-600"
            >
              Login
            </a>
          </div>
          ...
          >
            ...
            >
              <div class="px-5 pt-4 flex items-center justify-between">
                ...
                <div class="-mr-2">
                  <PopoverButton
                    class="bg-white rounded-md p-2 inline-flex items-center justify-center text-blue-gray-400 hover:bg-blue-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
                  >
              ...
              <div class="pt-5 pb-6">
                <div class="px-2 space-y-1">
                  <a
                    ...
                    :key="item.name"
                    :href="item.href"
                    class="block px-3 py-2 rounded-md text-base font-medium text-blue-gray-900 hover:bg-blue-gray-50"
                    >{{ item.name }}</a
                  >
                </div>
                <div class="mt-6 px-5">
      ...
      <div
        class="relative mt-24 max-w-md mx-auto px-4 pb-32 sm:max-w-3xl sm:px-6 md:mt-32 lg:max-w-7xl lg:px-8"
      >
        <h1
    ...
    <main>
      <div class="bg-blue-gray-50">
        ...
        <!-- FAQ -->
        <section
          class="max-w-md mx-auto py-24 px-4 divide-y-2 divide-blue-gray-200 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8"
          aria-labelledby="faq-heading"
        >
          <h2
            class="text-3xl font-extrabold text-blue-gray-900"
            id="faq-heading"
          >
      ...
      <section class="relative bg-white" aria-labelledby="join-heading">
        <div
          class="hidden absolute inset-x-0 h-1/2 bg-blue-gray-50 lg:block"
          aria-hidden="true"
        />
        <div class="max-w-7xl mx-auto bg-blue-600 lg:bg-transparent lg:px-8">
          <div class="lg:grid lg:grid-cols-12">
            ...
            >
              <div
                class="absolute inset-x-0 h-1/2 bg-blue-gray-50 lg:hidden"
                aria-hidden="true"
              />
              <div
            ...
            >
              ...
              >
                ...
                <a
                  class="block w-full py-3 px-5 text-center bg-white border border-transparent rounded-md shadow-md text-base font-medium text-blue-700 hover:bg-blue-gray-50 sm:inline-block sm:w-auto"
                  href="#"
      ...
      <!-- Newsletter Section -->
      <section
        class="max-w-md mx-auto py-24 px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:flex lg:items-center"
        aria-labelledby="newsletter-heading"
      >
        <div class="lg:w-0 lg:flex-1">
          <h2
            class="text-3xl font-extrabold text-blue-gray-900 sm:text-4xl"
    ...
    <footer class="bg-blue-gray-50" aria-labelledby="footer-heading">
      ...
      <div
        class="max-w-md mx-auto py-12 px-4 sm:max-w-7xl sm:px-6 lg:py-16 lg:px-8"
      >
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3
                  class="text-sm font-semibold text-blue-gray-400 tracking-wider uppercase"
                >
                  Solutions
                </h3>
