...
<template>
  <div class="bg-white">
    ...
    <main
      class="mx-auto pt-14 pb-24 px-4 sm:pt-16 sm:pb-32 sm:px-6 lg:max-w-7xl lg:px-8"
    >
      <!-- Product -->
      <div
      ...
      <div class="max-w-2xl mx-auto mt-24 sm:mt-32 lg:max-w-none">
        <div class="flex items-center justify-between space-x-4">
          ...
          <a
            href="#"
            class="whitespace-nowrap text-sm font-medium text-indigo-600 hover:text-indigo-500"
    ...
    <footer aria-labelledby="footer-heading" class="bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          class="py-20 grid grid-cols-1 md:grid-cols-12 md:grid-flow-col md:gap-x-8 md:gap-y-16 md:auto-rows-min"
        >
          <!-- Image section -->
          ...
          >
            ...
            <form class="mt-3 sm:flex lg:block xl:flex">
              ...
              <input
                ...
                autocomplete="email"
                required=""
                class="block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 sm:flex-1 sm:min-w-0 sm:max-w-xs lg:max-w-none"
              />
              <div
                class="mt-4 sm:mt-0 sm:ml-4 sm:flex-shrink-0 lg:mt-4 lg:ml-0 xl:mt-0 xl:ml-4"
              >
                <button
                  type="submit"
