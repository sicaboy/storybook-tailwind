                ...
                <PopoverGroup class="ml-8">
                  <div class="h-full flex justify-center space-x-8">
                    ...
                    >
                      ...
                      >
                        <PopoverPanel
                          class="absolute top-full inset-x-0 bg-white text-gray-500 text-sm transform -translate-y-px"
                        >
                          ...
                          <div
                            class="absolute inset-0 z-10 top-0 h-px max-w-7xl mx-auto px-8"
                            aria-hidden="true"
                          >
                            <div
                              :class="[
