  ...
  <div class="bg-white">
                  ...
                  <PopoverGroup class="ml-8">
                    <div class="h-full flex justify-center space-x-8">
                      ...
                      >
                        ...
                        >
                          <PopoverPanel
                            class="absolute z-10 top-full inset-x-0 text-gray-500 sm:text-sm"
                          >
    ...
    <main class="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div class="space-y-24">
          ...
          >
            ...
            <div class="mt-6 sm:col-span-7 sm:mt-0 md:row-end-1">
              ...
              <p class="font-medium text-gray-900 mt-1">{{ product.price }}</p>
      ...
      <section aria-labelledby="summary-heading" class="mt-24">
        ...
        <div
          class="bg-gray-50 rounded-lg py-6 px-6 lg:px-0 lg:py-8 lg:grid lg:grid-cols-12 lg:gap-x-8"
        >
          <dl
          ...
          <dl
            class="mt-8 divide-y divide-gray-200 text-sm lg:mt-0 lg:pr-8 lg:col-span-7"
          >
    ...
    >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          class="py-20 grid grid-cols-2 gap-8 sm:gap-y-0 sm:grid-cols-2 lg:grid-cols-4"
        >
          <div
